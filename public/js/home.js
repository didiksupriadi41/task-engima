...
function formatMovieHtml(result, index) {
    var poster = (result[index].poster == null) ?
        `<img class="home-poster" src="${dir}/img/no_img_placeholder.jpg">` :
...
window.onload = function () {
    if (pageCount < 2) {
        ...
        ajax(inputPage.value, mainMovieWrapper);
        var page = parseInt(inputPage.value, 10);
        // var i = pagination;
        if (page == 1) {
            prevButton.disabled = true;
        ...
        // else {
        //     while (i > 0) {
        //         pageButton[pagination - i].innerHTML = parseInt(page, 10) - i + 1
        //         pageButton[pagination - i].disabled = false;
        //         if ((parseInt(pageCount, 10) - i + 1) == page) {
        //             pageButton[pagination - i].disabled = true;
        //         }
        //         i -= 1;
        //     }
        //     //     pageButton[page - 1].disabled = true;
        //     if (page == parseInt(pageCount, 10)) {
        //         nextButton.disabled = true;
        //     }
        // }
    }
